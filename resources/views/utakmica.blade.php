...
<div class="app">
  <div class="header">
    <span class="team team-left">
     <img src="{{$utakmica->domacin_url}}" alt="" class="logo">
      <span class="name">{{$utakmica->domacin}}</span>
    </span>
    <span class="stats">{{$utakmica->domacin_golovi}}-{{$utakmica->gost_golovi}}</span>
    <span class="team team-right">
      <img src="{{$utakmica->gost_url}}" alt="" class="logo">
      <span class="name">{{$utakmica->gost}}</span>
    </span>

    <p style="font-size: 12px;">Finished</p>
  </div>
  </div>
  <p style="font-size: 20px;">Match Statistics</p>
  <p style="font-size: 18px;">{{$utakmica->opis}}</p>
</div>
